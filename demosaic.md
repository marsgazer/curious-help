...
This text is documentation from the _Curious X3D Viewer_ ( [https://github.com/martianch/curieux/](https://github.com/martianch/curieux/) )
software project and is published among the project's files at github:
[https://github.com/martianch/curieux/blob/master/demosaic.md](https://github.com/martianch/curieux/blob/master/demosaic.md)
